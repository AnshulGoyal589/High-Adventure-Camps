...
const images: GalleryImage[] = [
    { id: '1', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765472383/DSC04147_basbyc.jpg', alt: 'A vibrant camping site at dusk' },
    { id: '2', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765472540/DSC03378_ykkrs0.jpg', alt: 'Person ziplining across a valley' },
    { id: '3', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765472667/DSC08839_j6fpjk.jpg', alt: 'Crossing a Burma Bridge high above the ground' },
    { id: '4', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765473039/DJI_0313_iwmswh.jpg', alt: 'Navigating a bamboo bridge' },
    { id: '5', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765473089/DJI_0307_jtprtl.jpg', alt: 'Climbing a commando net challenge' },
    { id: '6', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765473297/DSC04199_uclcil.jpg', alt: 'Rock climbing a steep cliff face' },
    { id: '7', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765473324/DSC04209_x4ygng.jpg', alt: 'Rappelling down a waterfall' },
    { id: '8', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765474033/DJI_0300_pn1zxt.jpg', alt: 'Group trekking through a lush mountain trail' },
    { id: '9', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765474073/DSC04160_r56pr7.jpg', alt: 'Cozy tent pitched under the stars' },
    { id: '10', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765474102/DSC04166_m8g4gj.jpg', alt: 'Team building games in an open field' },
    { id: '11', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765474129/DSC09422_gdaets.jpg', alt: 'Mountaineers reaching a snowy summit' },
    { id: '12', src: 'https://res.cloudinary.com/drr75ydni/image/upload/v1765474174/log_walk_ainlwh.jpg', alt: 'Peaceful nature walk through a dense forest' },
